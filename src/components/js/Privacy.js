  ...
  return (
    <>
      <div className="privacy-div">
        ...
        <p className="privacyP">Last updated: June 20, 2022</p>
        ...
        <h2 className="privacyH2">Definitions</h2>
        <p className="privacyP">For the purposes of this Privacy Policy:</p>
        <ul className="privacy-ul">
          ...
          <li className="privacy-li">
            <p className="privacyP">
              ...
              in this Agreement) refers to Unchain.
            </p>
          </li>
          <li className="privacy-li">
            <p className="privacyP">
          ...
          <li className="privacy-li">
            <p className="privacyP">
              <strong>Website</strong> refers to Unchain, accessible from{" "}
              <a
                className="privacyLink"
                href="https://unchain.netlify.app/"
                rel="external nofollow noopener noreferrer"
                target="_blank"
              >
                https://unchain.netlify.app/
              </a>
            </p>
          </li>
          <li className="privacy-li">
        ...
        <ul className="privacy-ul">
          <li className="privacy-li">
            <p className="privacyP">Email address</p>
          </li>
          <li className="privacy-li">
        ...
        <ul className="privacy-ul">
          <li className="privacy-li">
            ...
            <p className="privacyP">Type: Session Cookies</p>
            <p className="privacyP">Administered by: Us</p>
            <p className="privacyP">
          ...
          <li className="privacy-li">
            ...
            <p className="privacyP">Type: Persistent Cookies</p>
            <p className="privacyP">Administered by: Us</p>
            <p className="privacyP">
        ...
        <h2 className="privacyH2">Use of Your Personal Data</h2>
        <p className="privacyP">
        ...
        <h2 className="privacyH2">Retention of Your Personal Data</h2>
        <p className="privacyP">
        ...
        <h2 className="privacyH2">Transfer of Your Personal Data</h2>
        <p className="privacyP">
        ...
        <ul className="privacy-ul">
          <li className="privacy-li">Comply with a legal obligation</li>
          <li className="privacy-li">
          ...
          <li className="privacy-li">Protect against legal liability</li>
        </ul>
        <h2 className="privacyH2">Security of Your Personal Data</h2>
        <p className="privacyP">
