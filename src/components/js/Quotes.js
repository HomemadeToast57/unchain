export const quotes = [
  //array of quotes that each have an id quote and author
  {
    id: 0,
  ...
  },
  {
    id: 25,
    quote:
      "Getting sober was one of the the three pivotal events in my life, along with becoming an actor and having a child. Of the three, finding my sobriety was the hardest.",
  ...
  {
    id: 43,
    quote: "Don't let the past steal your present.",
  ...
  {
    id: 47,
    quote: "The only thing that can keep you going is the desire to do more.",
    author: "Unknown",
  },
  {
    id: 48,
